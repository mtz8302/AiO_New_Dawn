...
struct attribute s_logger_attributes[] = {
  {"enableSerial", "bool", NULL, offsetof(struct logger, enableSerial), 0, false},
  {"serialLevel", "int", NULL, offsetof(struct logger, serialLevel), 0, false},
  {"enableUDP", "bool", NULL, offsetof(struct logger, enableUDP), 0, false},
  {"syslogPort", "int", NULL, offsetof(struct logger, syslogPort), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_stats_attributes[] = {
  {"eventCount", "int", NULL, offsetof(struct stats, eventCount), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};

struct apihandler_data s_apihandler_logger = {{"logger", "data", false, 0, 0, 0UL}, s_logger_attributes, sizeof(struct logger), (void (*)(void *)) glue_get_logger, (void (*)(void *)) glue_set_logger};
struct apihandler_data s_apihandler_stats = {{"stats", "data", false, 0, 0, 0UL}, s_stats_attributes, sizeof(struct stats), (void (*)(void *)) glue_get_stats, (void (*)(void *)) glue_set_stats};
...
static struct apihandler *s_apihandlers[] = {
  (struct apihandler *) &s_apihandler_logger,
  (struct apihandler *) &s_apihandler_stats,
